        ...
        <div class="col-md-12 ">
            <div class="card border-0">
                <div class="card-header">
                    ...
                    <a href="{{ route('swapnosarothiprofile.index') }}"><button type="submit" class="btn btn-sm btn-warning"
                            style="color: white"> Draft
                            List</button></a>
                    <a href="{{ route('swapnosarothi.profile.pending.list') }}"><button type="submit"
                            class="btn btn-primary active" style="color: white"><i class="fa fa-check-circle"
    ...
    <script>
        $(document).ready(function() {
            var dTable = $('#data-table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: '{{ route('get.swapnosarothi.profile.pending.list.datatable') }}',
                    data: function(d) {
                        d._token = "{{ csrf_token() }}";
