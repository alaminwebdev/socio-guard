...
<meta name="meetings" content="{{ json_encode($activityDataObj->meeting_activity) }}">
{{-- {{ dd($activityData) }} --}}
<form action="{{ route('activity.add_step_2', ['step' => 3]) }}" method="post">
    {{ csrf_field() }}
    ...
    <div class="card custom-card-style">
        ...
        <div id="meeting_container">
            <!-- Consolidated error message section -->
            @if ($errors->any())
            ...
            @if (count($activityData) > 0 && count(@$activityData[0]->meeting_activity) == 0)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if (loginUserRole()->user_role[0]->role_id == 1)
                                        <input autocomplete="off" value="" type="date" placeholder="dd-mm-yy" class="margin-bottom form-control form-control-sm" name="starting_date[]" required>
                                    @else
                                        <input autocomplete="off" value="" type="text" placeholder="dd-mm-yy" id="start_date_picker" class="margin-bottom form-control form-control-sm" name="starting_date[]" id="panel_staff_date" required>
                                    @endif
                                </div>
                                <div class="col-md-3">
                                    <label class="control-label">Ending Date</label>
                                    @if (loginUserRole()->user_role[0]->role_id == 1)
                                        <input autocomplete="off" value="" type="date" placeholder="dd-mm-yy" class="margin-bottom form-control form-control-sm" name="ending_date[]" required>
                                    @else
                                        <input autocomplete="off" value="" type="text" placeholder="dd-mm-yy" id="end_date_picker" class="margin-bottom form-control form-control-sm" name="ending_date[]" id="panel_staff_date" required>
                                    @endif
                                </div>
            ...
            @endif
            @foreach ($activityData[0]->meeting_activity as $key => $value)
                @if ($key + 1 < 2)
                    <div id="meeting_container_1" class="m-bottom card-body">
                        <div class="m-top row">
                            <div class="p-top p-left bg-color col-md-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label"> Starting Date </label>
                                        @if (loginUserRole()->user_role[0]->role_id == 1)
                                            <input value="{{ $value->starting_date != null ? date('Y-m-d', strtotime($value->starting_date)) : '' }}" type="date" placeholder="dd-mm-yy" class="margin-bottom form-control form-control-sm" name="starting_date[]" required>
                                        @else
                                            <input autocomplete="off" value="{{ $value->starting_date != null ? date('d-m-Y', strtotime($value->starting_date)) : '' }}" type="text" placeholder="dd-mm-yy" id="start_date_picker" class="margin-bottom form-control form-control-sm" name="starting_date[]" id="panel_staff_date" required>
                                        @endif
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Ending Date</label>
                                        @if (loginUserRole()->user_role[0]->role_id == 1)
                                            <input autocomplete="off" value="{{ $value->ending_date != null ? date('Y-m-d', strtotime($value->ending_date)) : '' }}" type="date" placeholder="dd-mm-yy" class="margin-bottom form-control form-control-sm" name="ending_date[]" required>
                                        @else
                                            <input autocomplete="off" value="{{ $value->ending_date != null ? date('d-m-Y', strtotime($value->ending_date)) : '' }}" type="text" placeholder="dd-mm-yy" id="end_date_picker" class="margin-bottom form-control form-control-sm" name="ending_date[]" id="panel_staff_date" required>
                                        @endif
                                    </div>
    ...
    <div class="text-right">
        <a href="{{ route('activity.add', ['step' => 1, 'selp_activity_ref' => $activityData[0]->selp_activity_ref]) }}" class="btn btn-success">Back</a>
        {{-- <a href="{{route('activity.add',['step'=>3])}}" class="btn  btn-success" >Save & Next</a> --}}
...
@include('backend.activity.activity_script', ['events' => $meeting_event])
<script>
    $(function() {
