		...
		<div class="card">
			...
			<div class="card">
				<div class="card-header">
					...
					@endif --}}
					<a href="{{ route('activity.draft.list') }}"><button type="submit" class="btn btn-warning btn-sm"  style="color: white">Draft List</button></a>
					...
					<a href="{{ route('activity.approved.list') }}"><button type="submit" class="btn btn-success active"  style="color: white"><i class="fa fa-check-circle" aria-hidden="true"></i> Approved List</button></a>
...
<script type="text/javascript">
   ...
   //          },
            ajax: {
            	url:'{{ route("activity.getActivityApproveList") }}',
            	data: function (d) {
            		console.log(d);
            		d._token      				= "{{ csrf_token() }}";
