...
<meta name="meetings" content="{{ json_encode($activityDataObj->pt_production_activity) }}">

<form action="{{route('activity.add_step_7',['step'=>1])}}" method="post">
    {{ csrf_field() }}
...
<div class="card custom-card-style">
    ...
    <div id="meeting_container">
        @if (count($activityData) > 0 && count(@$activityData[0]->pt_production_activity) == 0)
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select is_event_type="true" name="event_id[]" offset="0" onchange="checkChange(this)" id="evt_id_1" class=" form-control form-control-sm select2">
                                    ...
                                    @foreach ($pt_production_event as $item)
                            ...
                            <div style="margin-left:10px" class="row">
                                ...
                                <div class="form-group col-md-1 community_awareness">
                                    <label class="control-label">Intersex</label>
        ...
        @endif
        @foreach($activityData[0]->pt_production_activity as $key => $value)
            @if ($key+1 < 2)
                <div id="meeting_container_1" class="m-bottom card-body">
                    <div  class="m-top row">
                        <div class="p-top p-left bg-color col-md-10">
...
<div class="text-right">
    <a href="{{route('activity.add',['step'=>6, 'selp_activity_ref'=>$activityData[0]->selp_activity_ref])}}" class="btn btn-success" >Back</a>
    ...
    @else
        <button type="submit" name="save_destroy" class="btn btn-warning final text-white mr-1" onClick="this.form.submit(); this.disabled=true; this.value='Sending…';">Submit</button>
    @endif

    {{-- <input type="submit" name="save_destroy" value="Submit" class="btn btn-success"> --}}
...
@include('backend.activity.activity_script',['events'=>$pt_production_event])
<script>
    $( function() {
