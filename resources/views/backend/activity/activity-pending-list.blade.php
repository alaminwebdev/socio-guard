		...
		<div class="card">
			...
			<div class="card">
				<div class="card-header">
					...
					<a href="{{ route('activity.pending.list') }}"><button type="submit" class="btn btn-primary active"  style="color: white"><i class="fa fa-check-circle" aria-hidden="true"></i> Pending List</button></a>
...
<script type="text/javascript">
   ...
   //          },
            ajax: {
            	url:'{{ route("activity.getActivityPendingList") }}',
            	data: function (d) {
            		console.log(d);
            		d._token      				= "{{ csrf_token() }}";
