...
<div class="container"></div>
    <div id="exTab1" class="container">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" id="pills-profile-tab" href="{{ route('tab2') }}" role="tab" aria-controls="pills-profile" aria-selected="false">Violence Incident details</a>
          </li>
          <li class="nav-item">
...
<div class="text-center" style="color: #ec1e8c"><h6>Year {{ $current_year }}, Violence incident details</h6></div>
<br>
  <div class="row">
    <div class="col-md-6" id="chartdiv5Display" style="display: none; background-color: #dbf9db; ">
        <h6 class="text-center">Type of Violence experience</h6><br>
        <div class="row">
        <div class="col-md-12">
          <div id="chartdiv5" style="padding-left: 20px; height: 170px"></div>
    ...
    <div class="col-md-6" id="chartdiv4Display" style="display: none; background-color: #eafeff; ">
      <h6 class="text-center">Reasons behind the violence incidents</h6><br>
        <div class="row">
          <div class="col-md-12">
            <div id="chartdiv4" style="padding-left: 20px; height: 170px"></div>
...
<script type="text/javascript">
  function chartdiv5(region_id,division_id,district_id,start_date,end_date,violence_category_id,violence_sub_category_id,violence_name_id,violence_reason_id){
    $.ajax({
      url : "{{route('survivor.all.information.getchart21')}}",
      type : "GET",
      data : {
        region_id:region_id,
        division_id:division_id,
