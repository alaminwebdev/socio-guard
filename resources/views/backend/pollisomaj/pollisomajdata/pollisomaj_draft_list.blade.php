			...
			<div class="card-body">
				...
				<div class="card">
					<div class="card-header">
						{{-- @if($auth_user->user_role[0]['role_id'] == 5)
						@endif --}}
						<a href="{{ route('incident.pollisomaj.viewpollisomajDraftList') }}"><button type="submit" class="btn btn-warning active"  style="color: white"><i class="fa fa-check-circle" aria-hidden="true"></i> Draft List</button></a>
...
<script type="text/javascript">
	$(document).ready(function(){
		var dTable = $('#pollisomaj-data-table').DataTable({
			...
			serverSide: true,
            ajax: {
            	url:'{{ route("incident.pollisomaj.getPollisomajDraftList") }}',
            	data: function (d) {
            		console.log(d);
            		d._token      				= "{{ csrf_token() }}";
