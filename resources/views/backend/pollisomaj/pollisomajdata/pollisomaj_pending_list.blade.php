			...
			<div class="card-body">
				...
				<div class="card">
					<div class="card-header">
						...
						<a href="{{ route('incident.pollisomaj.viewpollisomajPendingList') }}"><button type="submit" class="btn btn-primary active"  style="color: white"><i class="fa fa-check-circle" aria-hidden="true"></i> Pending List</button></a>
						<a href="{{ route('incident.pollisomaj.viewpollisomajApproveList') }}"><button type="submit" class="btn btn-success btn-sm"  style="color: white">Approved List</button></a>
					</div>
					<div class="card-body">
...
<script type="text/javascript">
	$(document).ready(function(){
		var dTable = $('#pollisomaj-data-table').DataTable({
			...
			serverSide: true,
            ajax: {
            	url:'{{ route("incident.pollisomaj.getPollisomajPendingList") }}',
            	data: function (d) {
            		console.log(d);
            		d._token      				= "{{ csrf_token() }}";
