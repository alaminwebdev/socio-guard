    ...
    <div class="container-fluid">
        <div class="card card-success card-outline">
            ...
            <div class="card-body show_module_more_event region_area_info">
                <form action="{{route('add.pollisomaj')}}" method="POST">
					@csrf
					<div class="form-row">
                        <div class="form-group col-md-2">
                            <label for="name">Pollishomaj No <span class="text-danger">*</span></label>
                            <input type="text" name="pollisomaj_no" class="form-control form-control-sm {{$errors->has('pollisomaj_no')? 'is-invalid' : ''}}" id="pollisomaj_no" placeholder="Pollishomaj No." value="{{old('pollisomaj_no')}}" autofocus required>
                            <div class="invalid-feedback">
                                {{ $errors->first('pollisomaj_no') }}
                            </div>
						</div>
						<div class="form-group col-md-2">
                            <label for="name">Pollishomaj Name <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control form-control-sm {{$errors->has('name')? 'is-invalid' : ''}}" id="name" placeholder="Pollishomaj Name" value="{{old('name')}}" autofocus required>
                            <div class="invalid-feedback">
                                {{ $errors->first('name') }}
                            </div>
						</div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control form-control-sm" name="village_name" id="">
                        </div>
                        <div class="form-group col-md-2">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input required="" type="text" class="form-control form-control-sm" name="name_1" id="">
                        </div>

                        <div class="form-group col-md-6">
                            <label class="control-label"> Mobile No </label>
                            <input required="" type="text" class="form-control form-control-sm InputPhone" maxlength="11" name="mob_1" id="">
                            {{-- <input type="text" class="form-control form-control-sm" placeholder="" pattern="^(\+88|0088|88)?01[1-9]{1}\d{2}\d{6}$" id="InputPhoneFirst" name="InputPhone" required=""> --}}
                        </div>
                        <div class="form-group col-md-6">
                            <label class="control-label"> Secretary Name </label>
                            <input type="text" class="form-control form-control-sm" name="name_2" id="">
                        </div>

                        <div class="form-group col-md-6">
                            <label class="control-label"> Mobile No </label>
                            <input type="text" class="form-control form-control-sm InputPhone" maxlength="11" name="mob_2" id="">
                        </div>
                        <div class="form-group col-md-6">
                            <label class="control-label"> Cashier Name </label>
                            <input type="text" class="form-control form-control-sm" name="name_3" id="">
                        </div>

                        <div class="form-group col-md-6">
                            <label class="control-label"> Mobile No </label>
                            <input type="text" class="form-control form-control-sm InputPhone" maxlength="11" name="mob_3" id="">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_girls" id="member_girls" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Boys:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_boys" id="member_boys" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Female:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_female" id="member_female" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Male:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_male" id="member_male" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Other Gender:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_transgender" id="member_transgender" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Total:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="general_member_total" id="general_member_total" readonly="">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            <label class="control-label">Girls:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_girls_pwd" id="member_girls_pwd" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Boys:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_boys_pwd" id="member_boys_pwd" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Female:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_female_pwd" id="member_female_pwd" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Male:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_male_pwd" id="member_male_pwd" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Other Gender:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="member_transgender_pwd" id="member_transgender_pwd" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label">Total:</label>
                            <input  type="number"  value="" class="form-control form-control-sm" name="general_member_pwd_total" id="general_member_pwd_total" readonly="">
                        </div>
					</div>
