		...
		<div class="col-md-12 card">
			...
			<div class="card">
				<div class="card-header">
					...
					<a href="{{ route('incident.pending.list') }}"><button type="submit" class="btn btn-primary active"  style="color: white"><i class="fa fa-check-circle" aria-hidden="true"></i> Pending List</button></a>
...
<script type="text/javascript">
   ...
   //          },
            ajax: {
            	url:'{{ route("incident.getSelpIncidentPendingDatatable") }}',
            	data: function (d) {
            		console.log(d);
            		d._token      				= "{{ csrf_token() }}";
