...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<!-- Form Start-->
			<form method="post" action="{{ route('setup.cepregion.region.update', $editData->id) }}" id="myForm">
				{{ csrf_field() }}
				<div class="card-body">
					<div class="form-row">
						<div class="form-group col-md-4">
							<label class="control-label">Zone Name</label>
							<input type="text" name="region_name" class="form-control form-control-sm" value="{{ @$editData->region_name }}" placeholder="Zone Name">
						</div>
