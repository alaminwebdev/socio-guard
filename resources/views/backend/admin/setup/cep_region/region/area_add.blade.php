...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<!-- Form Start-->
			<form method="post" action="{{ route('setup.cepregion.region.areaStore') }}" id="myForm">
				{{ csrf_field() }}
				<div class="card-body">
						...
						<div class="region_area">
							<div class="form-row region_area_info">
								...
								<div class="form-group col-md-3">
									...
									<select name="district_id[]" el_type="zone_district_flag" class="form-control form-control-sm district_id district_check" required="">
										<option value="">Select District</option>
									</select>
								</div>
								<div class="form-group col-md-2">
									<label class="control-label">Date from</label>
									<input type="date" class="form-control form-control-sm district_id"  name="date_from[]" id="">
								</div>
								<div class="form-group col-md-2">
									<label class="control-label">Date to</label>
									<input type="date" class="form-control form-control-sm district_id"  name="date_to[]" id="">
								</div>
