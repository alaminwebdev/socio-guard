		...
		<div class="card">
			<div class="card-header">
				<h5>
					...
					<a class="btn btn-sm btn-success float-right" href="{{ route('setup.cepregion.district_manager.view') }}"><i class="fa fa-list"></i> District Manager List</a>
				</h5>
			</div>
			<!-- Form Start-->
			<form method="post" action="{{ route('setup.cepregion.district_manager.store') }}" id="myForm" autocomplete="off">
				{{ csrf_field() }}
				<div class="card-body">
					<div class="show_module_more_event">
						<div class="form-row">
							<div class="form-group col-md-4">
								...
								<input type="text" name="employee_name" class="form-control form-control-sm" value="" placeholder="Manager Name"/>
							</div>
							<div class="form-group col-md-4">
								<label class="control-label">PIN</label>
								<input type="text" name="employee_pin" class="form-control form-control-sm" value="" placeholder="Employee PIN"/>
							</div>
							<div class="form-group col-md-4">
