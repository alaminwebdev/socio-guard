...
<div class="col-xl-12">
	<div class="breadcrumb-holder">
		<h1 class="main-title float-left">Add Follow-Up Question-Options</h1>
...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<!-- Form Start-->
			<form method="post" action="{{ route('followup.question.option.store') }}" id="myForm">
				{{ csrf_field() }}
				<div class="card-body">
					<div class="question">
						<div class="form-row">
						...
						<div class="option_area">
							<div class="form-row option">
								<div class="form-group col-md-3">
									...
									<input type="text" name="option[]" class="form-control form-control-sm" value="" placeholder="Option">
								</div>
