		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-row">
					...
					<div class="col-md-2">
						<p style="font-weight: bold;font-size: 16px;padding-left: 5px;">Violenc Incident ID:</p>
					</div>
					<div class="col-md-1">
			    ...
			    <div class="accordion md-accordion accordion-2" id="accordionEx7" role="tablist"
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a data-toggle="collapse" data-parent="#accordionEx7" href="#collapse1" aria-expanded="true"
			            aria-controls="collapse1"  class="this-parent card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading1">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			              Information Sender: (Brac Staff)
			              <span class="btn btn-primary btn-sm pull-right scl">+</span>
			            </h6>
			          </a>
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a  data-toggle="collapse" data-parent="#accordionEx7" href="#collapse2"
			            aria-expanded="false" aria-controls="collapse2" class="this-parent collapsed card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading2">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			              Source of primary information provider @if(@$editIncident->provider_applicable_status=='1')<i class="fa fa-check-circle fa-success"></i>@elseif(@$editIncident->provider_mobile_no!=null)<i class="fa fa-check-circle fa-success"></i>@endif
			              <span class="btn btn-primary btn-sm pull-right scl">+</span>
			            </h6>
			          </a>
			        <!-- Card body -->
			        <div id="collapse2" class="collapse extra-detail" role="tabpanel" aria-labelledby="heading2"
			          data-parent="#accordionEx7">
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a  data-toggle="collapse" data-parent="#accordionEx7" href="#collapse3"
			            aria-expanded="false" aria-controls="collapse3" class="this-parent collapsed card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading3">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			        ...
			        <!-- Card body -->
			        <div id="collapse3" class="collapse extra-detail" role="tabpanel" aria-labelledby="heading3"
			          data-parent="#accordionEx7">
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a data-toggle="collapse" data-parent="#accordionEx7" href="#collapse4"
			            aria-expanded="false" aria-controls="collapse4" class="this-parent collapsed card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading3">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			        ...
			        <!-- Card body -->
			        <div id="collapse4" class="collapse extra-detail" role="tabpanel" aria-labelledby="heading3"
			          data-parent="#accordionEx7">
			          	<form method="post" action="{{!empty($editIncident->id)?route('incident.violence.update',$editIncident->id):route('incident.violence.store')}}" id="survivorInfoForm" class="survivorInfoForm">
			          	{{csrf_field()}}
				        	<div class="card-body mb-1 rgba-grey-light white-text">
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a data-toggle="collapse" data-parent="#accordionEx7" href="#collapse5"
			            aria-expanded="false" aria-controls="collapse5" class="this-parent collapsed card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading3">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			        ...
			        <!-- Card body -->
			        <div id="collapse5" class="collapse extra-detail" role="tabpanel" aria-labelledby="heading3"
			          data-parent="#accordionEx7">
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a data-toggle="collapse" data-parent="#accordionEx7" href="#collapse6"
			            aria-expanded="false" aria-controls="collapse6" class="this-parent collapsed card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading3">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			        ...
			        <!-- Card body -->
			        <div id="collapse6" class="collapse extra-detail" role="tabpanel" aria-labelledby="heading3"
			          data-parent="#accordionEx7">
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a data-toggle="collapse" data-parent="#accordionEx7" href="#collapse7"
			            aria-expanded="false" aria-controls="collapse7" class="this-parent collapsed card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading3">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			        ...
			        <!-- Card body -->
			        <div id="collapse7" class="collapse extra-detail" role="tabpanel" aria-labelledby="heading3"
			          data-parent="#accordionEx7">
			      ...
			      <div class="card">
			        ...
			        <!-- Card header -->
			          <a data-toggle="collapse" data-parent="#accordionEx7" href="#collapse8"
			            aria-expanded="false" aria-controls="collapse8" class="this-parent collapsed card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading3">
			            <h6 class="mb-0 white-text text-uppercase font-thin">
			              Support for Survivors @if(@$editIncident['survivor_brac_support']['0']['survivor_support_applicable_status']=='1')<i class="fa fa-check-circle fa-success"></i>@elseif(@$editIncident['survivor_brac_support']['0']!=null)<i class="fa fa-check-circle fa-success"></i>@endif
			              <span class="btn btn-primary btn-sm pull-right scl">+</span>
			            </h6>
			          </a>

			        <!-- Card body -->
			        <div id="collapse8" class="collapse extra-detail" role="tabpanel" aria-labelledby="heading3"
			          data-parent="#accordionEx7">
