  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col col-sm-12 text-center">
        <h5 style="font-weight: bold">Violence Incident Information(Violence Incident ID : {{$incident->survivor_id}}) | Posting Date : {{ date('Y-m-d', strtotime($incident->created_at)) }}</h5>
      </div>
    </div>
    </div>
    <div class="row">
      <div class="col-sm-12">
        ...
        <table border="1" width="100%">
          <tbody>
                <tr>
                  <td width="4%" class="text-center" rowspan="3"><p style="font-weight: bold;">1</p></td>
                  <td colspan="3"><p style="font-weight: bold;">Information Sender</p></td>
                </tr>
                <tr>
                    <td width="32%"><p>Name: {{@$incident->employee_name}}</p></td>
                    <td width="32%"><p>Mobile No: {{@$incident->employee_mobile_number}}</p></td>
                    <td width="32%"><p>Designation: {{@$incident->employee_designation}}</p></td>
                  </tr>
                  <tr>
                ...
                @if(@$incident->provider == "1" || @$incident->provider == NULL)
                  <tr>
                    <td width="4%" class="text-center"><p style="font-weight: bold;">2</p></td>
                    <td ><p style="font-weight: bold;">Source of Primary Information Provider (Individual)</p></td>
                  </tr>
                ...
                @else
                  <tr>
                    <td width="4%" class="text-center" rowspan="3"><p style="font-weight: bold;">2</p></td>
                    <td colspan="3"><p style="font-weight: bold;">Source of Primary Information Provider (Source)</p></td>
                  </tr>
                  <tr>
                    <td><p>Source: @if($incident->provider!='0'){{$incident['information_provider_source']['name']}}@else{{$incident->provider_other_source}}@endif</p></td>
                    <td colspan="2"><p>Source Name: {{@$incident->source_name}}</p></td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="3"><p>Address: {{$incident['source_union']['name']}},{{$incident['source_upazila']['name']}},{{$incident['source_district']['name']}},{{$incident['source_division']['name']}}</p></td>
                  </tr>
                @endif
                {{-- Provider End --}}
                {{-- Violence-Incident Start --}}
                <tr>
                  <td width="4%" class="text-center" rowspan="4"><p style="font-weight: bold;">3</p></td>
                  <td colspan="3"><p style="font-weight: bold;">Particulars of Violence Incidents</p></td>
                </tr>
                <tr>
                  <td><p>Violence Category: {{$incident['violencecategoryname']['name']}}</p></td>
                  <td><p>Violence Sub Category: {{$incident['violencesubcategoryname']['name']}}</p></td>
                  {{-- <td><p>Violence Name: {{$incident['violencename']['name']}}</p></td> --}}
                  <td><p>Violence Name: </p></td>
                </tr>
                <tr>
                  <!-- <td><p>Date: {{date('d-m-Y',strtotime($incident->violence_date))}}</p></td> -->
                  <td><p>Date: {{(@$incident->violence_date != NULL)? date('d-m-Y',strtotime($incident->violence_date)) :""}}</p></td>
                  <td><p>Time: {{date('h:i a',strtotime($incident->violence_time))}}</p></td>
                  <td><p>Place: {{$incident['provider_place']['name']}}</p></td>
                </tr>
                <tr>
                  <td><p>Reason of Violence: {{$incident['violencereason']['name']}}</p></td>
                ...
                <tr>
                  ...
                  <td><p>If Perpetrator family member: </p></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td width="4%" class="text-center" rowspan="4"><p style="font-weight: bold;">6</p></td>
                ...
                <tr>
                  <td><p>Case/FIR/GD no.: {{$incident->case_no}}</p></td>
                  <td><p>Case/FIR/GD Date: {{$incident->case_filed_date}}</p></td>
                </tr>
                <tr>
                  <td colspan="3"><p>Reason of not filing a case against perpetrator:{{@$incident['not_filing_reason']['name']}}</p></td>
                </tr>
                {{-- Legal Initiaves End --}}
                ...
                {{-- Brac Support --}}
                <tr>
                  <td colspan="3"><p>Date: {{(@$incident['survivor_brac_support']['0']['survivor_support_date'] != NULL)? date('d-m-Y',strtotime($incident['survivor_brac_support']['0']['survivor_support_date'])) :""}}</p></td>
        ...
        <div class="row">
          <div class="col-sm-12 text-center">
            <h3>Information Sender Missing, Please Fill Up Correctly</h3>
          </div>
        </div>
        @endif --}}
