...
<div class="container"></div>
    <div id="exTab1" class="container">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="pills-home-tab" href="{{ route('dashboard') }}" role="tab" aria-controls="pills-home" aria-selected="true">State of Violence Incidents</a>
          </li>
          <li class="nav-item">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="text-center" style="color: #ec1e8c"><h6>Year {{ $current_year }}, Violence experienced by</h6></div>
                <br>
                <div class="row">
                  <div class="col-sm-1">
                  ...
                  <div class="col-md-10">
                    <div class="row">
                      ...
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-bx-md radius" style="margin-top: -4px;"><a href=""><img src="{{asset('backend/images/women.png') }}" alt=""></a> </div>
                          <div class="icon-content p-r40">
                              <h2>{{ $current_data_survivor_women }}</h2>
                              <p><b>Women</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-bx-md radius" style="margin-top: -4px;"><a href=""><img src="{{asset('backend/images/girl.png') }}" alt=""></a> </div>
                          <div class="icon-content p-r40">
                              <h2>{{ $current_data_survivor_women_girls }}</h2>
                              <p><b>Girl's</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-bx-md radius" style="margin-top: -4px;"><a href=""><img src="{{asset('backend/images/boy.png') }}" alt=""></a> </div>
                          <div class="icon-content p-r40">
                              <h2>{{ $current_data_survivor_women_boys }}</h2>
                              <p><b>Boy's</b></p>
                          </div>
                      </div>
                    </div>
                ...
                <!-- <br>
                <div class="text-center" style="color: #ec1e8c"><h6>Year 2016-2019, Violence experienced by</h6></div>
                <br>
                <div class="row">
                  <div class="col-sm-1">
                  ...
                  <div class="col-md-10">
                    <div class="row">
                      ...
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-bx-md radius" style="margin-top: -4px;"><a href=""><img src="{{asset('backend/images/women.png') }}" alt=""></a> </div>
                          <div class="icon-content p-r40">
                              <h2>{{ $previous_data_survivor_women }}</h2>
                              <p><b>Women</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-bx-md radius" style="margin-top: -4px;"><a href=""><img src="{{asset('backend/images/girl.png') }}" alt=""></a> </div>
                          <div class="icon-content p-r40">
                              <h2>{{ $previous_data_survivor_girls }}</h2>
                              <p><b>Girl's</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-bx-md radius" style="margin-top: -4px;"><a href=""><img src="{{asset('backend/images/boy.png') }}" alt=""></a> </div>
                          <div class="icon-content p-r40">
                              <h2>{{ $previous_data_survivor_boys }}</h2>
                              <p><b>Boy's</b></p>
                          </div>
                      </div>
                    </div>
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6" id="chartdiv5Display" style="display: none; background-color: #dbf9db; ">
                <h6 class="text-center">Age of women survivors</h6>
                <div class="row">
                <div class="col-md-12">
            ...
            <div class="col-md-6" id="chartdiv4Display" style="display: none; background-color: #eafeff; ">
              <h6 class="text-center">Age of Children survivors</h6>
                <div class="col-md-12">
