...
<div class="col-xl-12">
	<div class="breadcrumb-holder">
		<h1 class="main-title float-left">Violence Reason Report</h1>
		<ol class="breadcrumb float-right">
			<li class="breadcrumb-item">Home </li>
			<li class="breadcrumb-item active">Violence Reason Report</li>
		</ol>
...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="{{ route('reason-report-pdf.view') }}" id="filterForm" target="_blank">
				{{ csrf_field() }}
					<div class="form-row">
