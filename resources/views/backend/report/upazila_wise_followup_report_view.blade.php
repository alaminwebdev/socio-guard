...
@section('content')
    <div class="col-xl-12">
        <div class="breadcrumb-holder">
            <h1 class="main-title float-left">Upazila Wise Follow Up Report</h1>
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item">Home </li>
                <li class="breadcrumb-item active">Upazila Wise Follow Up Report</li>
            </ol>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>Upazila Wise Follow Up Report</h5>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('upazila.wise.followup.report.create') }}" id="filterForm"
                        target="_blank">
                        @csrf
                        <div class="form-row mb-3">
                            <div class="form-group col-4">
                                ...
                                <select name="report_type" id="report_type" class="form-control form-control-sm select2"
                                    ...
                                    <option value="1">1. No.of survivors received Followup(ADR completed with decesion
                                        (office) and self/out side)</option>
                                    <option value="2">2. No.of survivors received Followup(On going court case)
                                    </option>
