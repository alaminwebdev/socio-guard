...
<div class="col-xl-12">
	<div class="breadcrumb-holder">
		<h1 class="main-title float-left">District Wise Report</h1>
...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="{{ route('district-wise-report-pdf.view') }}" id="filterForm" target="_blank">
				{{ csrf_field() }}
					<div class="form-row">
                        ...
                        <div class="form-group col-md-2">
							...
							<input type="checkbox" id="district_all" name="district_all" value="1">&nbsp;All
							<!-- <label class="control-label">District</label> -->
						...
						<!-- <div class="form-group col-sm-2">
							...
							<input type="checkbox" id="reason_all" name="reason_all" value="1">&nbsp;All
							<select name="reason_id" id="reason_id" class="reason_id form-control form-control-sm">
								<option value="0">Select Reason</option>
								@foreach($reasons as $cat)
...
<script type="text/javascript">
  $(function(){
    $(document).on('change','#region_id',function(){
      	...
      	if(region_id != '0'){
			$("#district_all").attr('disabled', true);
	    }else{
			$("#district_all").attr('disabled', false);
	    }
      	$.ajax({
...
<script type="text/javascript">
	$('[name^="district_all"]').change(function(){
    if($(this).is(":checked"))
	    {
	        $(this).next("select").attr("disabled",true);
	    }
