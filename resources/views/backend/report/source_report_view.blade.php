...
<div class="col-xl-12">
	<div class="breadcrumb-holder">
		<h1 class="main-title float-left">Source Report</h1>
...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="{{ route('source-report-pdf.view') }}" id="filterForm" target="_blank">
				{{ csrf_field() }}
					<div class="form-row">
						...
						<div class="form-group col-sm-2">
							...
							<input type="checkbox" id="source_all" name="source_all" value="1">&nbsp;All
							<select name="source_id" id="source_id" class="source_id form-control form-control-sm">
								<option value="0">Select Type</option>
								@foreach($sources as $cat)
