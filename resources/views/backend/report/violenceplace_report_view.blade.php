...
<div class="col-xl-12">
	<div class="breadcrumb-holder">
		<h1 class="main-title float-left">People with disabilities Report</h1>
		<ol class="breadcrumb float-right">
			<li class="breadcrumb-item">Home </li>
			<li class="breadcrumb-item active">People with disabilities Report</li>
		</ol>
...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="{{ route('violenceplace-report-pdf.view') }}" id="filterForm" target="_blank">
				{{ csrf_field() }}
					<div class="form-row">
						...
						<div class="form-group col-sm-3">
							<label class="control-label"> Violence Place <span class="text-danger">*</span>&nbsp;</label>
							<input type="checkbox" id="place_all" name="place_all" value="1">&nbsp;All
							<select name="place_id" id="place_id" class="place_id form-control form-control-sm">
								<option value="0">Select Violence Place</option>
								@foreach($violenceplaces as $cat)
