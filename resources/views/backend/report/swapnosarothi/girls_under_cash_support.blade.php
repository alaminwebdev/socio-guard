            ...
            <tr>
                ...
                <th colspan="4" style="padding: 0; vertical-align: middle; width:50%; border-bottom:0;">
                    <table class="table nested-table" style="margin-bottom: 0;">
                        ...
                        <tr>
                            <th style="vertical-align: middle; width:25%; border-left:0; border-bottom:0; border-top:0" class="text-center">Medium Cash</th>
                            <th style="vertical-align: middle; width:25%; border-left:0; border-bottom:0; border-top:0" class="text-center">Low Cash</th>
                            <th style="vertical-align: middle; width:25%; border-left:0; border-bottom:0; border-top:0" class="text-center">No Cash Support</th>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" class="parent-td" style="padding: 0;vertical-align: middle;">
                                        <table style="margin-bottom: 0; width:100%;" class="inner-table">
                                            <tr style="">
                                                <td style="width:25%; border-left:0; border-top:0; border-bottom:0" class="text-right" data-toggle="tooltip" data-placement="bottom" title="Medium Cash">
                                                    {{ @$group_list['medium'] }}
                                                </td>
                                                <td style="width:25%; border-left:0; border-top:0; border-bottom:0" class="text-right" data-toggle="tooltip" data-placement="bottom" title="Low Cash">
                                                    {{ @$group_list['low'] }}
                                                </td>
                                                <td style="width:25%; border-left:0; border-top:0; border-bottom:0" class="text-right" data-toggle="tooltip" data-placement="bottom" title="No Cash">
                                                    {{ @$group_list['none'] }}
                                                </td>
