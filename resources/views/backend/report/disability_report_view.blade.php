...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="{{ route('disability-report-pdf.view') }}" id="filterForm" target="_blank">
				{{ csrf_field() }}
					<div class="form-row">
						...
						<div class="form-group col-sm-3">
							...
							<input type="checkbox" id="disability_all" name="disability_all" value="1">&nbsp;All
							<select name="disability_id" id="disability_id" class="disability_id form-control form-control-sm">
								<option value="0">Select Disability Status</option>
								@foreach($autistics as $cat)
