...
<div class="col-xl-12">
	<div class="breadcrumb-holder">
		<h1 class="main-title float-left">Platform Report</h1>
		<ol class="breadcrumb float-right">
			<li class="breadcrumb-item">Home </li>
			<li class="breadcrumb-item active">Platform Report</li>
		</ol>
...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="{{ route('platform-report-pdf.view') }}" id="filterForm" target="_blank">
				{{ csrf_field() }}
					<div class="form-row">
						...
						<div class="form-group col-sm-2">
							<label class="control-label"> Platform <span class="text-danger">*</span>&nbsp;</label>
							<input type="checkbox" id="platform_all" name="platform_all" value="1">&nbsp;All
							<select name="platform_id" id="platform_id" class="platform_id form-control form-control-sm">
								<option value="0">Select Type</option>
								@foreach($platform as $cat)
