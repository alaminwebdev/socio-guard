...
<div class="container"></div>
    <div id="exTab1" class="container">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="pills-contact-tab" href="{{ route('tab3') }}" role="tab" aria-controls="pills-contact" aria-selected="false">Perpetrators</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" id="pills-contact-tab" href="{{ route('tab4') }}" role="tab" aria-controls="pills-contact" aria-selected="false">Survivor’s received services</a>
          </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="text-center" style="color: #ec1e8c"><h6>Year {{ $current_year }}, Service facilitation</h6></div>
                <br>
                <div class="row">
                  <div class="col-sm-1">
                    ...
                    <div class="row">
                      ...
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-content p-r40">
                              <h2>{{ $previous_total_support }}</h2>
                              <p><b>Services facilitated</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-content p-r40">
                              <h2>{{ $previous_total_brac_support }}</h2>
                              <p><b>Services from BRAC</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-content p-r40">
                              <h2>{{ $previous_total_other_support }}</h2>
                              <p><b>Services from other GO/NGO</b></p>
                              <!-- <p><b>Services facilitated through referral linkages with other GO/NGO</b></p> -->
                          </div>
                      </div>
                    </div>
                  </div>
                ...
                <!-- <br>
                <div class="text-center" style="color: #ec1e8c"><h6>Year 2016-2019, Service facilitation</h6></div>
                <br>
                <div class="row">
                  <div class="col-sm-1">
                  ...
                  <div class="col-md-10">
                    <div class="row">
                      ...
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-content p-r40">
                              <h2>{{ $total_support_service }}</h2>
                              <p><b>Services facilitated</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-content p-r40">
                              <h2>{{ $total_brac_support }}</h2>
                              <p><b>Services from BRAC</b></p>
                          </div>
                      </div>
                      <div class="icon-bx-wraper bx-style-2 m-b30 p-a20 right m-r50" style="background-color: #ec1f8c; color: #ffffff; min-width:220px;">
                          <div class="icon-content p-r40">
                              <h2>{{ $total_other_support }}</h2>
                              <p><b>Services from other GO/NGO</b></p>
                          </div>
                      </div>
                    </div>
...
<br>
  <div class="text-center"><h6>Year {{ $current_year }}, Service facilitation</h6></div>
  <br>
  <div class="row">
    <div class="col-md-3">
    </div>
            ...
            <table class="table" style="width: 100%" id="data-table">
              ...
              <tbody>
                <tr class="table-primary">
                  ...
                  <td>{{ $survivor_physical_treatment }}</td>
                </tr>
                <tr class="table-secondary">
                  <th scope="row">2</th>
                  <td>Psychological</td>
                  <td>{{ $survivor_psychological }}</td>
                </tr>
                <tr class="table-success">
                  <th scope="row">3</th>
                  <td>Legal Aid</td>
                  <td>{{ $survivor_legal_aid }}</td>
                </tr>
                <tr class="table-warning">
                  <th scope="row">4</th>
                  <td>Social Reintegration</td>
                  <td>{{ $survivor_social_reintegration }}</td>
                </tr>
                <tr class="table-info">
                  <th scope="row">5</th>
                  <td>Social Rehabilitation</td>
                  <td>{{ $survivor_social_rehabilitation }}</td>
                </tr>
              </tbody>
            </table>
            <!-- <div class="col-md-12" id="chartdiv4Display" style="display: none; background-color: #eafeff; ">
              <h6 class="text-center">Survivor’s received services</h6>
                <div class="col-md-12">
...
<script type="text/javascript">
  function chartdiv4(region_id,division_id,district_id,start_date,end_date,violence_category_id,violence_sub_category_id,violence_name_id,violence_reason_id){
    $.ajax({
      url : "{{route('survivor.all.information.getchart22')}}",
      type : "GET",
      data : {
        region_id:region_id,
