...
<div class="container fullbody">
	<div class="row">
		<div class="col-md-12 card" style="padding-right: 0px;padding-left: 0px;">
			...
			<!-- Form Start-->
			<form method="post" action="{{ route('refferal.store') }}" id="myForm">
				{{csrf_field()}}
				<div class="card-body">
					<div class="show_module_more_event">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="name" id="name" class="form-control form-control-sm" value="" placeholder="Write Primary Refferal Name">
							</div>
						</div>
					</div>
					<div class="form-row">
