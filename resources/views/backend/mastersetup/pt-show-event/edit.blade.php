...
<div class="container fullbody">
	<div class="col-md-12">
		<div class="card">
			...
			<!-- Form Start-->
			<form method="post" action="{{ route('pt-show-event.update',$editData->id) }}" id="myForm">
				{{csrf_field()}}
					...
					<div class="show_module_more_event">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="name" id="name" class="form-control form-control-sm" value="{{@$editData->name}}" placeholder="Write PT Show Event Name">
							</div>
						</div>
