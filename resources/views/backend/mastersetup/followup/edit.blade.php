		...
		<div class="card">
			<div class="card-header">
				<h5>
					...
					Add Followup
					@endif 
					<a class="btn btn-sm btn-success float-right" href="{{route('followups.index')}}"><i class="fa fa-list"></i> Followup List</a></h5>
			</div>
			<!-- Form Start-->
					...
					<div class="show_module_more_event">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="name" id="name" class="form-control form-control-sm" value="{{@$editData->title}}" placeholder="Followup">
							</div>
						</div>
