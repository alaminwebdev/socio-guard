		...
		<div class="card">
			<div class="card-header">
				<h5>
					...
					Add Household Type
					@endif 
					<a class="btn btn-sm btn-success float-right" href="{{route('householdtypes.index')}}"><i class="fa fa-list"></i> Household Type List</a></h5>
			</div>
			<!-- Form Start-->
			<form method="post" action="{{!empty($editData->id) ? route('householdtypes.update',$editData->id) : route('householdtypes.store')}}" id="myForm">
				{{csrf_field()}}
					...
					<div class="show_module_more_event">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="name" id="name" class="form-control form-control-sm" value="{{@$editData->title}}" placeholder="Household Type">
							</div>
						</div>
