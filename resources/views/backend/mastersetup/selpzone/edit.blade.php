		...
		<div class="card">
			<div class="card-header">
				<h5>
					...
					Add Selp Zone
					@endif 
					<a class="btn btn-sm btn-success float-right" href="{{route('selpzones.index')}}"><i class="fa fa-list"></i> Selp Zone List</a></h5>
			</div>
			<!-- Form Start-->
					...
					<div class="show_module_more_event">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="name" id="name" class="form-control form-control-sm" value="{{@$editData->title}}" placeholder="Selp Zone">
							</div>
						</div>
