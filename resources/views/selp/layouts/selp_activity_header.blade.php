...
<body>
    <htmlpageheader name="page-header">
        ...
        <p style="text-align: center; margin-bottom: 0px;"><strong>Social Empowerment and Legal Protection (SELP)</strong></p>
        <p style="text-align: center; margin-bottom: 0px;"><strong>Activity Data Entry Report</strong></p>
    ...
    <htmlpagefooter name="page-footer">
        <div style="border-top: 1px solid #ddd;width: 100%;">
            <div style="font-size: 11px; float: left; width: 20%;text-align: left;">Printed Date : {{ date('d-M-Y') }}</div>
