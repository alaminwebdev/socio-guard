					...
					<div class="form-row">
						<div class="form-group col-md-3">
							...
							<select name="report_type" id="report_type" class="report_type form-control form-control-sm" required>
							  ...
							  <option value="{{ route('pollisomaj-mis-report-excel.view') }}"> Pollishomaj ID wise Report</option>
							  <option value="{{route('pollisomaj-child-marriage-prevention-report.generate')}}">No. Child Marriage Reported by Pollishomaj</option>
