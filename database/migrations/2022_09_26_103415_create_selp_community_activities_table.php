...
class CreateSelpCommunityActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selp_community_activities', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selp_community_activities');
    }
}
