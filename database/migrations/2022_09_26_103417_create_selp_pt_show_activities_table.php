...
class CreateSelpPtShowActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selp_pt_show_activities', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selp_pt_show_activities');
    }
}
