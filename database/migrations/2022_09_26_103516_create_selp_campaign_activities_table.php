...
class CreateSelpCampaignActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selp_campaign_activities', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selp_campaign_activities');
    }
}
