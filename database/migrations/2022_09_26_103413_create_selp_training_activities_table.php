...
class CreateSelpTrainingActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selp_training_activities', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selp_training_activities');
    }
}
